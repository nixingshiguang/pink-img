...
const App: React.FC = () => {
  ...
  const tools: Tool[] = [
    ...
    { id: 'exif', title: 'EXIF 编辑器', description: '查看和编辑图片元数据，如拍摄设备、日期 and 位置。', isNew: true, icon: <Info className="w-7 h-7 text-fuchsia-600" />, category: ['全部', '安全', '编辑'], color: 'bg-fuchsia-50' },
